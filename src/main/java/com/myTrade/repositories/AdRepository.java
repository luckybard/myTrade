...
//                                               Pageable pageable);
    ...
    @Query(value = "SELECT * FROM ad WHERE is_active = TRUE AND ad_category = :category AND city = :city " +
    ...
    Page<AdEntity> findByOwnerUsername(@Param("ownerUsername") String ownerUsername, Pageable pageable);
    ...
    Page<AdEntity> findUserFavouriteAdsByUserId(@Param("userId") Long userId, Pageable pageable);
